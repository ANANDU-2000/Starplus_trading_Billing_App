...
const PurchasesPage = () => {
  ...
  // Filter states
  const [filterPeriod, setFilterPeriod] = useState('all') // all, today, yesterday, week, lastWeek, month, custom
      ...
      <div className="p-2 sm:p-4">
        ...
        {analytics && (
          <>
            ...
            {/* Today's Total */}
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg border-2 border-blue-300 p-3 sm:p-4">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-xs sm:text-sm font-bold text-blue-900">Today's Purchases</h3>
            ...
            {/* This Week's Total */}
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg border-2 border-green-300 p-3 sm:p-4">
              <div className="flex items-center justify-between mb-2">
            ...
            {/* Top Supplier Today */}
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg border-2 border-orange-300 p-3 sm:p-4">
              <div className="flex items-center justify-between mb-2">
              ...
              {analytics.topSupplierToday ? (
                ...
                <div className="text-sm text-gray-500">No purchases today</div>
              )}
            </div>

            {/* Top Supplier This Week */}
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg border-2 border-purple-300 p-3 sm:p-4">
              <div className="flex items-center justify-between mb-2">
              ...
              {analytics.topSupplierWeek ? (
                ...
                <div className="text-sm text-gray-500">No purchases this week</div>
              )}
            </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
                    ...
                    {analytics.dailyStats.slice(0, 7).map((day, index) => {
                      ...
                      return (
                        <div key={index} className="flex items-center gap-2">
                          <div className="text-xs font-medium text-gray-700 w-20">
                          ...
                          <div className="text-xs text-gray-600 w-12 text-right">{day.count || 0}x</div>
                        </div>
                      )
                    })}
                  </div>
                ) : (
                  <div className="text-sm text-gray-500 text-center py-8">No purchase data available</div>
                )}
              </div>
              ...
              <div className="bg-white rounded-lg border-2 border-green-300 shadow-sm p-4">
                ...
                {analytics.supplierStats && analytics.supplierStats.length > 0 ? (
                      ...
                      return (
                        <div key={index} className="flex items-center gap-2">
                          ...
                          <div className="flex-1">
                            <div className="text-xs font-medium text-gray-900 truncate mb-1">{supplier.supplierName}</div>
                            <div className="bg-gray-100 rounded-full h-5 relative">
                              <div
                            ...
                            <div className="text-xs text-gray-500 mt-0.5">{supplier.count || 0} purchase(s), {supplier.itemCount || 0} item(s)</div>
                          </div>
                        </div>
                      )
                    })}
                  ...
                  <div className="text-sm text-gray-500 text-center py-8">No supplier data available</div>
                )}
              </div>
            </div>

            {/* Detailed Supplier Insights */}
            <div className="bg-white rounded-lg border-2 border-purple-300 shadow-sm mb-4">
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full text-xs">
                      <thead className="bg-purple-50">
                        <tr>
                          <th className="px-3 py-2 text-left font-bold text-gray-700 border-r border-purple-200">Rank</th>
                          <th className="px-3 py-2 text-left font-bold text-gray-700 border-r border-purple-200">Supplier Name</th>
                          <th className="px-3 py-2 text-right font-bold text-gray-700 border-r border-purple-200">Total Spent</th>
                          <th className="px-3 py-2 text-center font-bold text-gray-700 border-r border-purple-200">Purchases</th>
                          <th className="px-3 py-2 text-center font-bold text-gray-700 border-r border-purple-200">Total Items</th>
                          <th className="px-3 py-2 text-right font-bold text-gray-700">Avg Per Purchase</th>
                        </tr>
                      </thead>
                        ...
                        {analytics.supplierStats.map((supplier, index) => {
                          ...
                          return (
                            <tr key={index} className={`hover:bg-purple-50 ${isTopSupplier ? 'bg-purple-50 font-semibold' : ''}`}>
                              ...
                              <td className="px-3 py-2 text-center border-r border-purple-100">
                                <span className="text-gray-700">{supplier.itemCount || 0}</span>
                              </td>
                      ...
                      <tfoot className="bg-purple-100 font-bold">
                        <tr>
                          <td colSpan="2" className="px-3 py-2 border-r border-purple-200">TOTAL</td>
                          <td className="px-3 py-2 text-right border-r border-purple-200">
                            <span className="text-green-700">AED {analytics.totalAmount?.toFixed(2) || '0.00'}</span>
                          </td>
                          <td className="px-3 py-2 text-center border-r border-purple-200">
                            <span className="text-blue-700">{analytics.totalCount || 0}</span>
                          </td>
                          <td className="px-3 py-2 text-center border-r border-purple-200">
                            <span className="text-gray-700">{analytics.totalItems || 0}</span>
                          </td>
                          <td className="px-3 py-2 text-right">
