...
const SalesLedgerPage = () => {
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50 overflow-hidden">
      {/* Header - Fixed */}
      <div className="flex-shrink-0 bg-white border-b border-gray-200 shadow-sm px-2 md:px-4 py-2 md:py-3">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
          <div>
            <h1 className="text-lg md:text-xl lg:text-2xl font-bold text-gray-900">Sales Ledger</h1>
          ...
          <div className="flex items-center gap-1.5 md:gap-2 flex-wrap">
            ...
            <button
              ...
              className="px-2 md:px-3 py-1.5 bg-blue-600 text-white rounded text-xs font-medium hover:bg-blue-700 flex items-center gap-1"
            >
      ...
      <div className="flex-shrink-0 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-1.5 md:gap-2 lg:gap-3 px-2 md:px-4 py-2 md:py-3 bg-white border-b border-gray-200">
        ...
        <div className="bg-yellow-50 rounded p-1.5 md:p-2 lg:p-3 border-l-2 md:border-l-4 border-yellow-500">
          <div className="text-[9px] md:text-[10px] lg:text-xs text-gray-600 uppercase mb-0.5">Unpaid</div>
        ...
        <div className="bg-orange-50 rounded p-1.5 md:p-2 lg:p-3 border-l-2 md:border-l-4 border-orange-500">
          <div className="text-[9px] md:text-[10px] lg:text-xs text-gray-600 uppercase mb-0.5">Balance</div>
        ...
        <div className="bg-purple-50 rounded p-1.5 md:p-2 lg:p-3 border-l-2 md:border-l-4 border-purple-500">
          <div className="text-[9px] md:text-[10px] lg:text-xs text-gray-600 uppercase mb-0.5">Invoices</div>
      ...
      {loading ? (
        ...
        <div className="flex-1 overflow-hidden bg-white">
          ...
          <div className="hidden md:block h-full overflow-auto">
            <table className="w-full divide-y divide-gray-200 text-xs lg:text-sm">
              <thead className="bg-gray-100 sticky top-0 z-20 border-b-2 border-gray-300">
                <tr>
                  <th className="px-2 lg:px-3 py-2 text-left text-[10px] lg:text-xs font-bold text-gray-700 uppercase whitespace-nowrap border-r border-gray-300">
                    Date
                  </th>
                  <th className="px-2 lg:px-3 py-2 text-left text-[10px] lg:text-xs font-bold text-gray-700 uppercase whitespace-nowrap border-r border-gray-300">
                    Type
                  ...
                  <th className="px-2 lg:px-3 py-2 text-right text-[10px] lg:text-xs font-bold text-gray-700 uppercase whitespace-nowrap border-r border-gray-300">
                    Bill Amount
                  </th>
                  <th className="px-2 lg:px-3 py-2 text-right text-[10px] lg:text-xs font-bold text-gray-700 uppercase whitespace-nowrap border-r border-gray-300">
                    Paid Amount
                  ...
                  <th className="px-2 lg:px-3 py-2 text-center text-[10px] lg:text-xs font-bold text-gray-700 uppercase whitespace-nowrap border-r border-gray-300">
                    Status
                  </th>
                  <th className="px-2 lg:px-3 py-2 text-right text-[10px] lg:text-xs font-bold text-gray-700 uppercase whitespace-nowrap">
                    Balance
                  </th>
                </tr>
              </thead>
              ...
              <tfoot className="bg-gray-200 sticky bottom-0 border-t-4 border-gray-400">
                ...
                <tr className="bg-yellow-50">
                  <td
                    colSpan="5"
                    className="px-2 lg:px-3 py-2 text-right text-[10px] lg:text-xs font-semibold text-gray-700 border-r border-gray-300"
                  >
                    SUMMARY:
                  </td>
                  <td className="px-2 lg:px-3 py-2 text-right text-[10px] lg:text-xs font-semibold text-blue-700 border-r border-gray-300">
                    Sales: {formatCurrency(filteredSummary.totalSales)}
                  </td>
                  <td className="px-2 lg:px-3 py-2 text-right text-[10px] lg:text-xs font-semibold text-green-700 border-r border-gray-300">
                    Paid: {formatCurrency(filteredSummary.totalPayments)}
                  </td>
                  <td className="px-2 lg:px-3 py-2 text-right text-[10px] lg:text-xs font-semibold text-red-700 border-r border-gray-300">
                    Pending: {formatCurrency(filteredSummary.totalRealPending)}
                  </td>
                  <td className="px-2 lg:px-3 py-2 text-center text-[10px] lg:text-xs font-semibold text-gray-700 border-r border-gray-300">
                    -
                  </td>
                  <td className="px-2 lg:px-3 py-2 text-right text-[10px] lg:text-xs font-semibold text-orange-700 border-r border-gray-300">
                  ...
                  >
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex-1">
                        ...
                        <div className="text-[11px] text-gray-600">{entry.customerName}</div>
                    ...
                    <div className="grid grid-cols-2 gap-1.5 text-xs">
                      <div>
                        <div className="text-[9px] text-gray-500 uppercase">Bill</div>
                    ...
                    {entry.paymentMode && entry.paymentMode !== '-' && (
                      <div className="mt-1.5 pt-1.5 border-t border-gray-200">
                        ...
                        <span className="text-[10px] font-medium text-gray-700">{entry.paymentMode}</span>
                      </div>
                    )}
                  </div>
                )
