...
const BackupPage = () => {
  ...
  const handleRestore = async () => {
    ...
    if (!confirm('⚠️ WARNING: Are you sure you want to restore from this backup?\n\nThis will REPLACE ALL CURRENT DATA with the backup data!\n\nMake sure you have a backup of current data first!')) {
      return
    }
    ...
    try {
      ...
      if (response.success) {
        toast.success('✅ Backup restored successfully! The page will refresh in 3 seconds.')
        setTimeout(() => {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3 sm:p-4 lg:p-6 mb-4 sm:mb-6">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            >
              <HardDrive className="h-4 w-4 mr-2" />
              {loading ? 'Creating...' : 'Full Backup + Export to Desktop'}
            </button>
          </div>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-md p-3">
              <p className="text-sm text-yellow-800">
                <strong>⚠️ Important:</strong> To restore from a backup file:
              </p>
