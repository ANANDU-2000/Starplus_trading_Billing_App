...
const BillingHistoryPage = () => {
  ...
  useEffect(() => {
    ...
    // Auto-refresh sales list every 90 seconds (reduced frequency)
  ...
  const handleDeleteSale = async (saleId) => {
    if (!window.confirm('⚠️ WARNING: Are you sure you want to delete this invoice?\n\nThis will restore stock and cannot be undone!')) {
      return
    }
