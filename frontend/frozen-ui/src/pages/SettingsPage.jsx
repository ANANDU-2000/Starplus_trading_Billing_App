  ...
  const handleLogoUpload = async (event) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        // CRITICAL: Update app icon and manifest when logo is uploaded
        await updateAppIcon(logoUrl)
        
        toast.success('Logo uploaded successfully! App icon updated.')
  ...
  const handleLogoDelete = async () => {
    try {
      ...
      if (response.success) {
        ...
        // CRITICAL: Reset app icon to default when logo is deleted
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Input
              ...
              placeholder="STAR PLUS FOODSTUFF TRADING"
              required
        ...
        {user?.role?.toLowerCase() === 'admin' && (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-lg font-semibold text-gray-900">Cloud Backup Settings</h2>
            </div>
