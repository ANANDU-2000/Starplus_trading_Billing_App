...
const CustomersPage = () => {
  ...
  const handleDelete = async (customerId) => {
    ...
    if (hasTransactions) {
      ...
      confirmMessage = `⚠️ WARNING: This customer has transactions.\n\n` +
      ...
      confirmMessage = `⚠️ WARNING: Are you sure you want to delete "${customerName}"?\n\nThis action cannot be undone!`
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap gap-2 w-full sm:w-auto">
            ...
            <button
              ...
              className="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 border border-transparent rounded-lg shadow-sm text-xs sm:text-sm font-medium text-white bg-blue-600 hover:bg-blue-700"
            >
                    ...
                    <div className="flex items-center gap-1.5 sm:gap-2">
                      ...
                      {user?.role?.toLowerCase() === 'admin' && (
                        <button
                          ...
                          title="🗑️ Delete Customer (Admin Only)"
                        >
      ...
      >
        <div className="space-y-6">
          ...
          <div className="flex justify-end gap-2 mb-4">
            <button
              onClick={() => {
                // Navigate to payments page with customer pre-selected
                window.location.href = `/payments?customerId=${selectedCustomer?.id}`
              }}
