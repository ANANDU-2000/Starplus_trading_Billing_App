...
namespace FrozenApi.Controllers
{
    ...
    public class BackupController : ControllerBase
    {
        ...
        public BackupController(IComprehensiveBackupService backupService)
        {
        ...
        public async Task<ActionResult> DownloadBackup(string fileName)
        {
            try
            {
                ...
                var desktopPath = System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Desktop), "StarPlus_Backups");
