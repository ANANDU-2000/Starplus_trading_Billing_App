    ...
    public class FontService : IFontService
    {
        ...
        public void RegisterFonts()
        {
            ...
            try
            {
                ...
                {
                    _logger.LogWarning("⚠️ Fonts directory not found: {FontsDir}", fontsDir);
                    _logger.LogWarning("⚠️ Using system fallback fonts. Arabic may not render correctly.");
                ...
                {
                    _logger.LogWarning("⚠️ Font file not found: {Path}", notoRegular);
                }
                ...
                {
                    _logger.LogWarning("⚠️ Font file not found: {Path}", notoBold);
                }
                ...
                {
                    _logger.LogWarning("⚠️ No Arabic fonts found in {FontsDir}", fontsDir);
                    _logger.LogWarning("⚠️ Please download fonts as per Fonts/FONT_DOWNLOAD_INSTRUCTIONS.md");
                    _logger.LogWarning("⚠️ Using system fallback: Tahoma");
