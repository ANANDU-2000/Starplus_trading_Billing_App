        ...
        public async Task RecalculateCustomerBalanceAsync(int customerId)
        {
            ...
            try
            {
                ...
                _logger.LogInformation(
                    "Customer {CustomerId} balance recalculated: TotalSales={TotalSales}, TotalPayments={TotalPayments}, Pending={Pending}",
