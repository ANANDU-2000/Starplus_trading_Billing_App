...
namespace FrozenApi.Services
{
    ...
    {
        Task<StockAdjustmentDto> CreateAdjustmentAsync(CreateStockAdjustmentRequest request, int userId);
        Task<List<StockAdjustmentDto>> GetAdjustmentsAsync(int? productId = null, DateTime? fromDate = null, DateTime? toDate = null);
    }
    ...
    public class StockAdjustmentService : IStockAdjustmentService
    {
        ...
        public async Task<List<StockAdjustmentDto>> GetAdjustmentsAsync(int? productId = null, DateTime? fromDate = null, DateTime? toDate = null)
        {
