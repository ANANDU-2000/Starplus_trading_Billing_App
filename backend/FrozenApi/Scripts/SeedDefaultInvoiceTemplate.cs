...
namespace FrozenApi.Scripts
{
    public static class SeedDefaultInvoiceTemplate
    {
        public static async Task SeedAsync(AppDbContext context)
        {
            ...
            {
                Name = "HD Invoice Template (Starplus Format)",
                Version = "1.0",
                HtmlCode = htmlCode,
                CssCode = null, // CSS is embedded in HTML
                IsActive = true,
                Description = "Pixel-perfect invoice template matching Starplus Foodstuff Trading format with bilingual support (Arabic/English)",
